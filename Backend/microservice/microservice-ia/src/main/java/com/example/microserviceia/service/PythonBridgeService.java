...
public class PythonBridgeService {
    ...
    private List<Map<String, Object>> buildHistoriqueList(List<SaturationRecord> records) {
        return records.stream().map(r -> {
            ...
            h.put("anomalyScore", r.getAnomalyScore());
            h.put("zone_id", r.getZoneId());
            h.put("statut", r.getStatut().name());
            h.put("nbPylonesSatures", r.getNbPylonesSatures());
            h.put("nbPylonesTotal", r.getNbPylonesTotal());
            return h;
