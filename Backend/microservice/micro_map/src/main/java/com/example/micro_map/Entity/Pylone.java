...
public class Pylone {
    ...
    @JsonProperty("chargeActuelle")
    public Double getChargeActuelleFormatee() {
        if (chargeActuelle == null) return 0.0;
        return Math.round(chargeActuelle * 100.0) / 100.0;
    }
